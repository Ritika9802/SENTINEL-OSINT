...
def render_password_security():
    ...
    with col_b:
        ...
        if st.button("Password Strength Checker", key="btn_pwd_chk", type=t, use_container_width=True):
    ...
    if st.session_state.pwd_active == "generator":
        ...
        with st.form("password_generator_form", clear_on_submit=False):
            ...
            generate_password_clicked = st.form_submit_button("Generate Password", type="primary", use_container_width=True)
    ...
    #  Leak Check (HIBP k-Anonymity, fully inline) 
        ...
        with st.form("password_leak_form", clear_on_submit=False):
            ...
            check_leaks = st.form_submit_button("Check for Leaks", type="primary", use_container_width=True)
